...
Text files representing the maps of the UR campus and Monroe county are included, but the map of New York state was too large to add through Github. I have included an image file with an example output produced by my program with the nys.txt file.
